...
def get_rag_chain():
    ...
    rag_chain = build_rag_chain(history_aware_retriever,question_answer_chain)
...
def build_rag_chain(history_aware_retriever, question_answer_chain):
